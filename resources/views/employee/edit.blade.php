                        ...
                        <div class="col-md-6 ">
                            <div class="card em-card">
                                ...
                                <div class="card-body employee-detail-create-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            {!! Form::label('probation_id', __('Probation Id'), ['class' => 'form-label']) !!}
                                            {!! Form::date('probation_id', !empty($probation) &&  $probation->isNotEmpty() ? $probation->first()->probation : '', [
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter Probation Months',]) !!}
                                            {{-- {!! Form::number('probation_id', !empty($probation) ? $probation->first()->probation : '', ['class' => 'form-control', 'placeholder' => 'Enter Probation Months']) !!} --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
