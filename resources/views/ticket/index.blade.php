...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Manage Tasks') }}</li>
@endsection

@section('action-button')
    @can('Create Ticket')
        <a href="#" data-url="{{ route('ticket.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Task') }}"
                ...
                <div class="col-lg-3 col-6">
                    <div class="card ticket-card">
                        <div class="card-body">
                            ...
                            <p class="text-muted text-sm mt-4 mb-2"></p>
                            <h6 class="mb-3">{{ __('Close Task') }}</h6>
