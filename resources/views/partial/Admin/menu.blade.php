...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            {{-- @if (Gate::check('Employee Birthdays')) --}}
                @if (\Auth::user()->type == 'company')
                    <li class="dash-item {{ Request::segment(1) == 'employee_birthdays' ? 'active' : '' }}">
                        <a href="{{route('employee.birthday')}}" class="dash-link">
                            <span class="dash-micon"><i>
                                ...
                                class="dash-mtext">{{ __('Employee Birthday') }}</span>
                                </i>
                            </span></a>
                    </li>
                @endif
            ...
            <!-- employee birthday-->
             ...
             {{-- @if (Gate::check('Employee anniversary')) --}}
             @if (\Auth::user()->type == 'company')
                 <li class="dash-item {{ Request::segment(1) == 'employee_anniversary' ? 'active' : '' }}">
                     <a href="{{route('employee.anniversary')}}" class="dash-link">
                         <span class="dash-micon"><i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-check-fill" viewBox="0 0 16 16">
                             ...
                             class="dash-mtext">{{ __('Employee Anniversary') }}</span>
                             </i>
                         </span></a>
                 </li>
             @endif
            ...
            @can('Manage Ticket')
                <li class="dash-item {{ Request::segment(1) == 'ticket' ? 'active' : '' }}">
                    <a href="{{ route('ticket.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-ticket"></i></span><span class="dash-mtext">{{ __('Tasks') }}</span></a>
                </li>
            @endcan
