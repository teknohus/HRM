...
//     $migrationFilePath = database_path('migrations/2020_01_16_093256_create_leaves_table.php'); 
//     Artisan::call('migrate:specific', [
//         'file' => $migrationFilePath,
//     ]);
// });
// Route::get('test',function(){
//     // $migrationName = date('Y_m_d_His') .'_create_emailchecks_table';
//     // Artisan::call('make:migration', [
//     //     'name' => $migrationName,
//     // ]);
//     // Log::error('Something went wrong with the route: ' . $exception->getMessage());
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('employee_birthdays', [EmployeeController::class, 'birthday'])->name('employee.birthday')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('employee_anniversary', [EmployeeController::class, 'anniversary'])->name('employee.anniversary')->middleware(
        [
            'auth',
            'XSS',
        ]
