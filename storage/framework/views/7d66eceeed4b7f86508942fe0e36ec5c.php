...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <select class="form-select" name="leave_full_half" id="leave_full/half" aria-label="form-control select ">
...
<?php /**PATH /home/teknohus/hrm/resources/views/leave/create.blade.php ENDPATH**/ ?>