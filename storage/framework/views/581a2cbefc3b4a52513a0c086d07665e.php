                ...
                <div class="col-md-6 ">
                    <div class="card em-card">
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('probation_id', __('Probation'), ['class' => 'form-label']); ?>

                                    <?php echo Form::date('probation_id', old('probation_id'), [
                                        'class' => 'form-control',
                                        'placeholder' => 'Select Probation Date',
                                    ]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\M ZUBAIR SIDDIQUI\Desktop\hrm-live\resources\views/employee/create.blade.php ENDPATH**/ ?>