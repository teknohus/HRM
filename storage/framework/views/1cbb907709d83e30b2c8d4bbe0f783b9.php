                    ...
                    <div class="card ">
                        <div class="card-body employee-detail-body fulls-card emp-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Probation Ending on')); ?> :</strong>
                                        <?php if(!empty($probation) && $probation->isNotEmpty()): ?>
                                        <span><?php echo e($probation->first()->probation); ?></span> 
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\M ZUBAIR SIDDIQUI\Desktop\hrm-live\resources\views/employee/show.blade.php ENDPATH**/ ?>