    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <!-- employee birthday-->
                ...
                <?php if(\Auth::user()->type == 'company'): ?>
                    <li class="dash-item <?php echo e(Request::segment(1) == 'employee_birthdays' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('employee.birthday')); ?>" class="dash-link">
                            <span class="dash-micon"><i>
                                ...
                                class="dash-mtext"><?php echo e(__('Employee Birthday')); ?></span>
                                </i>
                            </span></a>
                    </li>
                <?php endif; ?>
            ...
            <!-- employee birthday-->
             ...
             <?php if(\Auth::user()->type == 'company'): ?>
                 <li class="dash-item <?php echo e(Request::segment(1) == 'employee_anniversary' ? 'active' : ''); ?>">
                     <a href="<?php echo e(route('employee.anniversary')); ?>" class="dash-link">
                         <span class="dash-micon"><i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-check-fill" viewBox="0 0 16 16">
                             ...
                             class="dash-mtext"><?php echo e(__('Employee Anniversary')); ?></span>
                             </i>
                         </span></a>
                 </li>
             <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Ticket')): ?>
                <li class="dash-item <?php echo e(Request::segment(1) == 'ticket' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('ticket.index')); ?>" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-ticket"></i></span><span class="dash-mtext"><?php echo e(__('Tasks')); ?></span></a>
                </li>
            <?php endif; ?>
...
<?php /**PATH C:\Users\M ZUBAIR SIDDIQUI\Desktop\hrm-live\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>