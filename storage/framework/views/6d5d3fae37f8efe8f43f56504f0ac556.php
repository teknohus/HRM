...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <div class="col-md-6 ">
                            <div class="card em-card">
                                <div class="card-header">
                                    <h5><?php echo e(__('Probation')); ?></h6>
                                </div>
                                <div class="card-body employee-detail-create-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <?php echo Form::label('probation_id', __('Probation Id'), ['class' => 'form-label']); ?>

                                            <?php echo Form::date('probation_id', !empty($probation) &&  $probation->isNotEmpty() ? $probation->first()->probation : '', [
                                                'class' => 'form-control',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\M ZUBAIR SIDDIQUI\Desktop\hrm-live\resources\views/employee/edit.blade.php ENDPATH**/ ?>