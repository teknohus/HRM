<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Tasks')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Manage Tasks')); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Ticket')): ?>
        <a href="#" data-url="<?php echo e(route('ticket.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Task')); ?>"
                ...
                <div class="col-lg-3 col-6">
                    <div class="card ticket-card">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3"><?php echo e(__('Total Tasks')); ?></h6>
                ...
                <div class="col-lg-3 col-6">
                    <div class="card ticket-card">
                        <div class="card-body">
                            ...
                            <p class="text-muted text-sm mt-4 mb-2"></p>
                            <h6 class="mb-3"><?php echo e(__('Open Task')); ?></h6>
                ...
                <div class="col-lg-3 col-6">
                    <div class="card ticket-card">
                        <div class="card-body">
                            ...
                            <p class="text-muted text-sm mt-4 mb-2"></p>
                            <h6 class="mb-3"><?php echo e(__('Hold Task')); ?></h6>
                ...
                <div class="col-lg-3 col-6">
                    <div class="card ticket-card">
                        <div class="card-body">
                            ...
                            <p class="text-muted text-sm mt-4 mb-2"></p>
                            <h6 class="mb-3"><?php echo e(__('Close Task')); ?></h6>
        ...
        <div class="col-xxl-4">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5><?php echo e(__('Task By Status')); ?></h5>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teknohus/hrm/resources/views/ticket/index.blade.php ENDPATH**/ ?>